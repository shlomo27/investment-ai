      ...
      >
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 max-w-sm w-full text-center space-y-4">
          ...
          <h2 className="text-white font-semibold">
            {isHe ? "משהו השתבש בטעינת המסך" : "Something went wrong loading this screen"}
          </h2>
          <p className="text-gray-400 text-sm leading-relaxed">
            {isHe
              ? "הנתונים שלך בטוחים. נסה לטעון מחדש — אם זה חוזר, ספר לנו מה ניסית לעשות."
              : "Your data is safe. Try reloading — if it keeps happening, tell us what you were doing."}
          </p>
          <button
