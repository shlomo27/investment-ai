  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
        <p className="text-xs text-gray-400 mb-1">{t("Total Value", "שווי כולל")}</p>
        <p className="text-xl font-bold">{fmt(summary.total_value)}</p>
      </div>
      <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
        <p className="text-xs text-gray-400 mb-1">{t("Cash", "מזומן")}</p>
        <p className="text-xl font-bold text-green-400">{fmt(summary.cash_balance)}</p>
      </div>
      <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
        <p className="text-xs text-gray-400 mb-1">{t("P&L", "רווח/הפסד")}</p>
      ...
      <div className="bg-gray-900 rounded-2xl p-5 border border-gray-800">
        <p className="text-xs text-gray-400 mb-1">{t("Positions", "עמדות")}</p>
